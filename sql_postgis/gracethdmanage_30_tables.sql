...
--NOTE : ATTENTION, IL Y A DES SET search_path to gracethdcheck DANS LE CODE

DROP TABLE IF EXISTS t_mg_filltab CASCADE;
DROP TABLE IF EXISTS t_mg_fillatt CASCADE;
DROP TABLE IF EXISTS t_mg_filldoc CASCADE;
DROP TABLE IF EXISTS t_mg_fillcnt CASCADE;
DROP TABLE IF EXISTS t_mg_va CASCADE;
DROP TABLE IF EXISTS t_mg_rx CASCADE;
DROP TABLE IF EXISTS t_mg_rg CASCADE;
DROP TABLE IF EXISTS t_mg_db CASCADE;
DROP TABLE IF EXISTS t_mg_tr CASCADE;
DROP TABLE IF EXISTS t_mg_xg CASCADE;
DROP TABLE IF EXISTS t_mg_md CASCADE;
DROP TABLE IF EXISTS t_mg_ac CASCADE;
DROP TABLE IF EXISTS t_mg_cn CASCADE;
DROP TABLE IF EXISTS t_mg_kt CASCADE;
DROP TABLE IF EXISTS t_mg_pj CASCADE;
DROP TABLE IF EXISTS t_mg_px CASCADE;
DROP TABLE IF EXISTS t_mg_ot CASCADE;
DROP TABLE IF EXISTS t_mg_op CASCADE;
DROP TABLE IF EXISTS t_mg_ox CASCADE;
DROP TABLE IF EXISTS t_mg_oo CASCADE;
DROP TABLE IF EXISTS t_mg_mcdtab CASCADE;
DROP TABLE IF EXISTS t_mg_mcdatt CASCADE;
DROP TABLE IF EXISTS t_mg_mcdlist CASCADE;
DROP TABLE IF EXISTS t_mg_mcdval CASCADE;
DROP TABLE IF EXISTS t_mg_mcdviews CASCADE;
DROP TABLE IF EXISTS t_mg_mcdcnt CASCADE;
