...
REM gracethdcheck_pg_import_shpcsv-in_psql.bat
...
ECHO GraceTHD - Debut import SHP CSV dans la base PostGIS %PGHOSTNAME%:%GLCTPGDB%. 
CALL:IMPORT
...
:END
ECHO GraceTHD - Fin import SHP CSV dans la base PostGIS %PGHOSTNAME%:%GLCTPGDB%. 
%GLPAUSE%
